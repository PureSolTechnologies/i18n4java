...
/**
 * This class is basis for FreeList and EnumList. It's used to provide a
 * basic functionality to connect a output string to a free object for
 * selection.
 * 
...
abstract public class AbstractExtendedList extends List {
	...
	for (int index = 0; index < displayItems.size(); index++) {
	    listData
		    .put(displayItems.get(index), assignedItems.get(index));
	}
