...
public class PrinterSupport {
	...
	private void showPageSetup() {
		if (printServices.length > 0) {
			...
			JOptionPane.showMessageDialog(Application.getInstance(), translator
					.i18n("No printing services available."), translator
	...
	private Dimension resolution() {
		...
		if (pr == null) {
			...
			res.setSize(pr.getCrossFeedResolution(PrinterResolution.DPI), pr
					.getFeedResolution(PrinterResolution.DPI));
		}
