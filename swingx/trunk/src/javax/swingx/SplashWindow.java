...
public class SplashWindow extends JWindow implements Runnable {
	...
	public void showProgressBarText(boolean visible) {
		if (progressBar != null) {
	...
	public static void main(String[] args) {
		SplashWindow splash = new SplashWindow(SplashWindow.class
				.getResource("/splashtest.jpg"), 200, 150);
		splash.setClosable(true);
		// splash.setTimer(10);
		splash.showProgressBar(true);
		splash.showProgressBarText(true);
		splash.setProgressBarText(null);
		splash.setProgressBarRange(0, 99);
