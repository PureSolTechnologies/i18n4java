...
package com.puresoltechnologies.i18n4java.utils;
	...
	public void testRecursiveFileSearch() {
		...
		for (File file : files) {
			...
			if (file.equals(new File(
					"/src/test/java/com/puresoltechnologies/i18n4java/utils/FileSearchTest.java"))) {
				foundSelf = true;
			}
			if (file.equals(new File(
					"/src/main/java/com/puresoltechnologies/i18n4java/utils/FileSearch.java"))) {
				foundClass = true;
			}
		}
