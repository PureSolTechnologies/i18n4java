...
import com.puresoltechnologies.i18n4java.data.SourceLocation;
...
public class LanguageSetTest {
	...
	public void testSettersAndGetters() {
		...
		assertTrue(locations
				.contains(new SourceLocation("TestFile.java", 1, 2)));
		assertTrue(locations
				.contains(new SourceLocation("TestFile2.java", 2, 3)));
		assertTrue(locations
				.contains(new SourceLocation("TestFile3.java", 3, 4)));
